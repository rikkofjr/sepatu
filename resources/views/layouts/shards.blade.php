...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Styles -->
        <link href="{{ asset('shards/styles/shards-dashboards.1.1.0.min.css') }}" rel="stylesheet">
        <link href="{{ asset('shards/styles/extras.1.1.0.min.css') }}" rel="stylesheet">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <!-- End Main Sidebar -->
        <main class="main-content col-lg-10 col-md-9 col-sm-11 p-0 offset-lg-2 offset-md-3">
            bav
        </main>
